...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__maeda

#else
#  define SWIG_init    init_maeda

#endif
#define SWIG_name    "_maeda"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_maedaplant(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOOOO:maedaplant",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7,&obj8)) SWIG_fail;
  {
    npy_intp dims[1];
    if (!PyInt_Check(obj0))
    {
  ...
  ecode17 = SWIG_AsVal_float(obj8, &val17);
  if (!SWIG_IsOK(ecode17)) {
    SWIG_exception_fail(SWIG_ArgError(ecode17), "in method '" "maedaplant" "', argument " "17"" of type '" "float""'");
  } 
  arg17 = (float)(val17);
  maedaplant(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16,arg17);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"maedaplant", _wrap_maedaplant, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
