...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_res2center(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOO:res2center",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6)) SWIG_fail;
  {
    npy_intp dims[1];
    if (!PyInt_Check(obj0))
    {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"res2center", _wrap_res2center, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
